...
public class SoapHelper {
  ...
  // метод для получения списка существующих проектов в Mantis
  public Set<Project> getProjects() throws MalformedURLException, RemoteException, ServiceException {
    MantisConnectPortType mc = getMantisConnect();
    // получаем список проектов, к которым пользователь имеет доступ
  ...
  // метод, возвращающий статус задачи в баг-трекере
