...
public class ContactModificationTests extends TestBase {
  ...
  public void testContactModificationTests() {
    ...
    ContactGroupData contact = new ContactGroupData().withId(modifiedContact.getId()).withFirstname("Ivanov").withMiddlename("Ivanovich").withLastname("Ivan").withAddress("USA").withEmail1("ivani@mail.ru").withHome("333-333").withMobile("111-111-111-11").withWork("22-22-22").inGroup(groups.iterator().next());
