...
public class ContactHelper extends HelperBase {
  ...
  public ContactGroupData infoFromEditForm(ContactGroupData contact) {
    ...
    return new ContactGroupData().withId(contact.getId()).withFirstname(firstname).withLastname(lastname).withAddress(address)
            .withHome(home).withMobile(mobile).withWork(work).withEmail1(email1).withEmail2(email2).withEmail3(email3);
  }
