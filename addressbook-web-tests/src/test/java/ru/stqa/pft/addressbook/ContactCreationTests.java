...
public class ContactCreationTests {
    ...
    public void testContactCreation() {
        gotoAddNewContact();
        fillGroupForm(new ContactGroupData("Suslova", "Igorevna", "Ekaterina", "Russia", "e_suslova@mail.ru", "12-12-12", "999-999-999-99", "123-123-456"));
    ...
    private void fillGroupForm(ContactGroupData contactGroupData) {
        ...
        wd.findElement(By.name("home")).sendKeys(contactGroupData.getHome());
        wd.findElement(By.name("mobile")).click();
        wd.findElement(By.name("mobile")).clear();
        wd.findElement(By.name("mobile")).sendKeys(contactGroupData.getMobile());
        wd.findElement(By.name("work")).click();
        wd.findElement(By.name("work")).clear();
        wd.findElement(By.name("work")).sendKeys(contactGroupData.getWork());
    }
